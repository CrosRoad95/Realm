...
internal sealed class ReactiveDxGuiHostedService : PlayerLifecycle, IHostedService
{
    private readonly IGuiSystemService _guiSystemService;
    private readonly LuaValueMapper _luaValueMapper;

    public ReactiveDxGuiHostedService(PlayersEventManager playersEventManager, IGuiSystemService guiSystemService, LuaValueMapper luaValueMapper) : base(playersEventManager)
    {
