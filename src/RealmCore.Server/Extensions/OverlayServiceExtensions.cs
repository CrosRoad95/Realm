...
public static class OverlayServiceExtensions
{
    ...
    {
        return overlayService.AddRing3dDisplay(entity.GetRequiredComponent<PlayerElementComponent>(), position, time);
    }

    public static void RemoveRing3dDisplay(this IOverlayService overlayService, Entity entity, string id)
    {
        overlayService.RemoveRing3dDisplay(entity.GetRequiredComponent<PlayerElementComponent>(), id);
    }
}
