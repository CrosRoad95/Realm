...
internal sealed class ReactiveDxGuiLogic : PlayerLogic
{
    ...
    public ReactiveDxGuiLogic(MtaServer mtaServer, IGuiSystemService guiSystemService, LuaValueMapper luaValueMapper) : base(mtaServer)
    {
    ...
    private void HandleGuiChanged(IPlayerGuiService arg1, RealmPlayer arg2, IPlayerGui? arg3, IPlayerGui? currentGui)
    {
