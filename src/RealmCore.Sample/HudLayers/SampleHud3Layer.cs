...
public class SampleHud3Layer : HudLayer<SampleHud3State>
{
    ...
    protected override void Build(IHudBuilder<SampleHud3State> x, IHudBuilderContext context)
    {
        ...
        x.AddText(x => x.Text, new Vector2(context.Right - 400, 600), new Size(200, 20), Color.Blue, scale: new Size(2, 2), font: "default", alignX: HorizontalAlign.Center, alignY: VerticalAlign.Center).AddShadow(new Vector2(2, 2));
    }
}
