...
{
    /// <inheritdoc />
    public partial class GroupsTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_GroupsRoles_GroupId", x => x.GroupId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupsRolesPermissions", x => new { x.GroupRoleId, x.PermissionId });
                    table.ForeignKey(
