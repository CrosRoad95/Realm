...
namespace RealmCore.Persistence.MySql.Migrations
{
    ...
    [Migration("20240830135018_RemoveRedundantMoneyHistoryTable")]
    partial class RemoveRedundantMoneyHistoryTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.TimeBaseOperationDataGroupUserData", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TimeBasedOperationId")
                        .HasColumnType("int");

                    b.Property<string>("Metadata")
                        .HasColumnType("longtext");

                    b.HasKey("UserId", "GroupId", "TimeBasedOperationId");

                    b.HasIndex("GroupId");

                    b.HasIndex("TimeBasedOperationId")
                        .IsUnique();
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.TimeBaseOperationDataGroupUserData", b =>
                {
                    b.HasOne("RealmCore.Persistence.Data.TimeBaseOperationGroupData", "Group")
                        .WithMany("TimeBasedOperationDataGroupUser")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RealmCore.Persistence.Data.TimeBaseOperationData", "Operation")
                        .WithOne("TimeBasedOperationDataGroupUser")
                        .HasForeignKey("RealmCore.Persistence.Data.TimeBaseOperationDataGroupUserData", "TimeBasedOperationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.TimeBaseOperationData", b =>
                {
                    b.Navigation("TimeBasedOperationDataGroupUser");
                });
