...
{
    /// <inheritdoc />
    public partial class BoostsTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActiveBoosts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActiveBoosts_Users_UserId",
                        column: x => x.UserId,
