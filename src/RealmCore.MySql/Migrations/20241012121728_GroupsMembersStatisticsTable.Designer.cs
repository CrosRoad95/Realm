...
namespace RealmCore.Persistence.MySql.Migrations
{
    ...
    [Migration("20241012121728_GroupsMembersStatisticsTable")]
    partial class GroupsMembersStatisticsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.BusinessData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.BusinessEventData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BusinessEvents", (string)null);
                });

            modelBuilder.Entity("RealmCore.Persistence.Data.BusinessStatisticData", b =>
                {
                    b.Property<int>("BusinessId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("BusinessId", "StatisticId");

                    b.ToTable("BusinessStatistics", (string)null);
                });

            modelBuilder.Entity("RealmCore.Persistence.Data.BusinessUserData", b =>
                {
                    b.Property<int>("BusinessId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("BusinessesUsers", (string)null);
                });
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.GroupMemberStatisticData", b =>
                {
                    ...
                    b.HasKey("GroupMemberId", "StatisticId", "Date");

                    b.ToTable("GroupsMembersStatistics", (string)null);
                });
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.MapData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.MapUserData", b =>
                {
                    ...
                    b.ToTable("MapsUsers", (string)null);
                });
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.SerialDiscordUserIdData", b =>
                {
                    ...
                    b.HasKey("Serial", "DiscordId");

                    b.ToTable("SerialDiscordUserId", (string)null);
                });
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.TimeBaseOperationGroupBusinessData", b =>
                {
                    ...
                    b.HasKey("OperationGroupId", "BusinessId");

                    b.HasIndex("BusinessId");

                    b.ToTable("TimeBaseOperationGroupBusinesses", (string)null);
                });
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.UserStatisticData", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.VehicleGroupAccessData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("VehicleGroupAccesses", (string)null);
                });
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.VehicleSettingData", b =>
                {
                    b.Property<int>("VehicleId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("VehicleId", "SettingId");

                    b.ToTable("VehicleSettings", (string)null);
                });
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.BusinessEventData", b =>
                {
                    b.HasOne("RealmCore.Persistence.Data.BusinessData", null)
                        .WithMany("Events")
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.BusinessStatisticData", b =>
                {
                    b.HasOne("RealmCore.Persistence.Data.BusinessData", "Business")
                        .WithMany("Statistics")
                        .HasForeignKey("BusinessId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.GroupMemberStatisticData", b =>
                {
                    b.HasOne("RealmCore.Persistence.Data.GroupMemberData", "GroupMember")
                        .WithMany("Statistics")
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.MapUserData", b =>
                {
                    b.HasOne("RealmCore.Persistence.Data.MapData", "Map")
                        .WithMany("MapsUsers")
                        .HasForeignKey("MapId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.TimeBaseOperationGroupBusinessData", b =>
                {
                    b.HasOne("RealmCore.Persistence.Data.BusinessData", "Business")
                        .WithMany("TimeBasedOperations")
                        .HasForeignKey("BusinessId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RealmCore.Persistence.Data.TimeBaseOperationGroupData", "OperationGroup")
                        .WithMany("Businesses")
            ...
            modelBuilder.Entity("RealmCore.Persistence.Data.BusinessData", b =>
                {
                    ...
                    b.Navigation("TimeBasedOperations");
