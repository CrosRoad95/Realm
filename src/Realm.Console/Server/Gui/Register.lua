local function createLoginWindow(guiProvider)
	local window = guiProvider.window(__("LoginWindow", "Login / Register"), 0, 0, 300, 270);
	...
	local repeatPasswordInput = guiProvider.input(100, 115, 180, 25, window);
	...
	local registerButton = guiProvider.button("Zarejestruj", 120, 185, 160, 20, window);
